...
| General | ChangeToParking | BOOLEAN |  | This setting defines if the system will execute the actions to change some motors to parking/notParking. If true before starting the bosch system some motors will change to parking.
If false no actions are executed before starting. |
